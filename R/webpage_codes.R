...
ncaaYearCodes <- function(year) {
  webpage_codes <- data.frame(
    ...
    'Hitting'=c(14643,11953,11000,10946,10780,10460,10120),
    'Pitching'=c(14644,11954,11001,10947,10781,10461,10121),
    'Fielding'=c(14645,11955,11002,10948,10782,10462,10122)
  )
